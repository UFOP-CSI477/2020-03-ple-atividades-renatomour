...
<html lang="en">
  ...
  <body >
    <form  action="{{route('salas.update', $sala->id)}}" method="post" style="border-style:solid; margin:20px; ">
    ...
    <div class="container" style="place-items:center; margin-top:30pt; margin-bottom:30pt">
           ...
           <h1 class="card-title" style="text-align:center; margin-bottom:20pt;">Cadastro de Salas </h1>
    <div class="row">
    <div class="col-md-6">
    <div class="form-group">
              
                <label for="nome">Nome: </label>
                 <input value="{{$sala->nome}}"type="text" class="form-control" id="nome" placeholder="Nome do Local" name="nome">
